...
export declare const CONTRAST_GAIN = 2;
export declare const CONTRAST_BIAS = -60;
/** Borne un rectangle a l'interieur de l'image (evite les extractions hors cadre). */
export declare function clampRect(rect: Rect, imgW: number, imgH: number): Rect;
/** Rectangle absolu (px) d'une zone relative. */
export declare function absRect(box: RelBox, imgW: number, imgH: number): Rect;
