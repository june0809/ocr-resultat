...
export declare function createBrowserWorker(opts?: BrowserOcrOptions): Promise<Worker>;
/**
 ...
 */
export declare function readScoreboardFromImage(source: CanvasImageSource, width: number, height: number, opts?: BrowserOcrOptions): Promise<BrowserReadResult>;
...
export declare function readScoreboardWith(worker: Worker, source: CanvasImageSource, width: number, height: number, opts?: ScoreboardOptions): Promise<BrowserReadResult>;
